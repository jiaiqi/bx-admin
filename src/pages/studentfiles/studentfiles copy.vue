<template>
    <el-main style="border: 1px solid #eee;width:100%;" class="print-layout">
            ...
            <el-col :span="24">
                <div style="width:100%;" class="padding-s" :style="``">
                    ...
                    <el-row type="flex" class="row-bg" justify="space-between">
                        ...
                        <el-col :span="24" style="justify-content: end;display: flex;" class="print">
        ...
        <template>
            <el-card class="box-card" style="border:0;" shadow="never" v-if="Array.isArray(childServiceLoadDatas['srvledu_semester_evaluate_labor_task_select'])">
                 <!-- 荣誉墙效果 -->
                <div slot="header" class="clearfix" style="">
            ...
            <el-card class="box-card" style="border:0;" shadow="never" v-if="Array.isArray(childServiceLoadDatas['srvledu_semester_evaluate_course_select'])">
                <!-- 课程评价统计 -->
                <div slot="header" class="clearfix" style="">
            ...
            <el-card class="box-card" style="border:0;" shadow="never" v-if="true && index == 0 && childServiceLoadDatas">
                <!-- 劳动任务完成统计 -->
                <div slot="header" class="clearfix" style="">
                        ...
                        <el-col :span="12" :style="`padding:8px;height:100%;`" >
                            <el-card class="" shadow="never" :style="`border:0px solid #eee;`">
                                <el-row :gutter="20" class="text item " style="padding:10px;" v-if="Array.isArray(childServiceLoadDatas['srvledu_semester_evaluate_task_state_select']) && childServiceLoadDatas['srvledu_semester_evaluate_task_state_select'].length > 0">
                                    <el-col :span="24" :style="`padding:8px;display: flex;align-items: center;text-align:center;position: relative;border-left:1px solid #eee;`" v-for="(item,index) in childServiceLoadDatas['srvledu_semester_evaluate_task_state_select']" class="font-weight-bold">
                                        <div style="color:#000;line-height:1.5rem;min-width:8rem;font-size:1rem;white-space: nowrap;text-align:left;padding-left:2rem;">{{item.task_state}}</div>
                                        <div style="padding:8px;text-align:left">
                                            <div :style="`color:${item.task_state == '未完成' ? 'red' :  '#007bff'};line-height:1.5rem;white-space: nowrap;`">
                                ...
                                <div slot="header" class="clearfix font-weight-bold" style="background:#f7f7f7;">
                                    ...
                                    <span style="border-left: 0px solid #ddd;padding-left:20px">{{`综合评分`}}
                                        <span style="color:red;min-width:2rem;font-size:1.4rem;">
                                            {{child['_load_data'].filter(item => item.semester == `${semester}`).reduce((total, num) => total + num.index_score, 0) / child['_load_data'].filter(item => item.semester == `${semester}`).length}}
                                        </span>
                                    </span>
                                </div>
                                <div  class="text item">
  ...
  export default {
    ...
    data() {
      return {
        ...
        taskTypeSum:null,
        taskTypeState:null,
        childServiceNames:['srvledu_semester_evaluate_task_type_select','srvledu_semester_evaluate_task_state_select'],
