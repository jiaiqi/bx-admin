<template>
  <div>
    ...
    <div class="field-group">
      ...
      >
        ...
        <el-form-item label="选择场所" style="margin-right: 40px">
          <el-select v-model="form.placement" placeholder="请选择场所">
            <el-option label="场所1" value="changsuo1"></el-option>
            <el-option label="场所2" value="changsuo2"></el-option>
            <el-option label="场所3" value="changsuo3"></el-option>
          </el-select>
        </el-form-item>
    ...
    <div style="padding: 0 20px;">选择时段</div>
