            ...
            <el-col :span="24" class="main-card-view">
                  ...
                  <el-row>
                    <el-form :inline="true" :model="searchOrgForm" class="demo-form-inline search-view">
                      ...
                      <el-form-item label="区域">
                        <el-input v-model="searchForm.area_name" placeholder="请输入区域"></el-input>
                      </el-form-item>
                      <el-form-item>
              ...
              <el-row>
                <el-card shadow="never">
                  <el-table :data="tableOrgData" :cell-style="{height: '50px',overflow: 'hidden'}" :stripe="true" style="width: 100%">
