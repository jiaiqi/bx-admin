<template>
  <div>
    ...
    <el-dialog title="批量选择操作" width="90%" :close-on-click-modal="1==2" :visible="activeForm == 'batch-edit-grid'" @close="activeForm = 'xx'" append-to-body >
      <batchEditGrid v-if="activeForm == 'batch-edit-grid' && batchInitConfig" @closeDialog="closeDialog" :initSelectedDatas="batchInitConfig.initSelectedDatas"  :buttonInfo="buttonInfo">
      </batchEditGrid>
    </el-dialog>
