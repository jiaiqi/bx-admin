<template>
  <div v-show="evalVisible()">
    ...
    <div class="table-list-row">
      ...
      <div v-else>
        ...
        <el-row type="flex" class="row-bg" justify="center">
          <el-table ref="bx-table-layout" :data="gridDataRun" stripe border style="width: 100%" :row-class-name="tableRowClassName" row-key="id" highlight-current-row @selection-change="handleSelectionChange" @filter-change="filterChange" @sort-change="handleSortChange" @row-dblclick="onRowDbClicked">
    ...
    <el-dialog title="二级密码验证" :show-close="false" width="40%" :close-on-click-modal="1==2" append-to-body :visible="activeForm == 'srv-auth-login'" @close="activeForm = 'xx'">
