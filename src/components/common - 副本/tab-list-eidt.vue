<template>
  <div>
    <filterTabs ref="filterTabs" v-if="tabs.length > 0 && cols.length > 0" :tabs="tabs" :srv="getService()" :cols="cols" @on-input-value="onFilterChange" 
...
<script>
  ...
  import List from "./list-table-edit";
  import Vue from 'vue'
