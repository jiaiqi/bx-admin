...
<template>
  <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
    ...
    <path
        ...
        fill="#FFFFFF" p-id="3701"></path>
    <path d="M682.666667 512h341.333333v213.333333h-341.333333z" fill="#107C41" p-id="3702"></path>
  </svg>
</template>
