export default {
  methods: {
              ...
              if (col_key == "child_data_list") {
                ...
                if (col_cfg["value_type"] == "constant") {
                  ...
                  if (
                    ...
                    typeof this.listMainFormDatas === "object" &&
                    Object.keys(this.listMainFormDatas).length > 0
                  ) {
                    new_data[col_key] =
                      this.listMainFormDatas[col_cfg["value_key"]] || null;
                  }
                }
              }
            }
     ...
     */
    buildCustomBtnDivCondUrl(btn, row, mainData) {
      const result = this.buildCustomBtnDivCond(btn, row, mainData)
     ...
     */
    buildCustomBtnDivCond(btn, row, mainData) {
      let result = null;
    ...
    async customizeurlFoward(item, operateData) {
      ...
      var back_url = this.url_pre_data_handle(
        item,
        operateData,
        mainDetailData
      );
    ...
    customize_save(item, operateData) {
      ...
      let isMerge =
        operate_params_cfg.is_merge !== undefined
          ? operate_params_cfg.is_merge
          : false;
      let draft =
        operate_params_cfg.draft !== undefined
          ? operate_params_cfg.draft
          : false;
      let paramsData =
        operate_params_cfg.data !== undefined ? operate_params_cfg.data : false;
