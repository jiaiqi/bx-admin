...
(function () {
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _move: function (initPos1, targetPos1, effect) {
            ...
            var init_pos = this._projection.lngLatToPoint(initPos1);

            var target_pos = this._projection.lngLatToPoint(targetPos1);
            ...
            if (count < 1) {
                ...
                var line = new BMap.Polyline(lineArray, {
                    strokeColor: 'red',
                    strokeWeight: 4,
                    strokeOpacity: 1
                });
                line.type = "line";
                me._map.addOverlay2(line);
                //璁剧疆鑷畾涔塷verlay鐨勪綅缃�
    ...
    baidu.object.extend(CustomOverlay.prototype, {
        ...
        setPosition: function (poi, markerSize) {
            ...
            console.log("你是什么？？到底是什么？？呀")
            console.log(poi,"poi是什么？？"); 
